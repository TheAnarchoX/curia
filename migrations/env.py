...
from curia_domain.db.models import (  # noqa: F401
    AgendaItemRow,
    AmendmentRow,
    AssertionRow,
    DebateSegmentRow,
...
db_url = os.getenv("CURIA_DATABASE_URL")
if db_url:
...
def run_migrations_online() -> None:
    """Run migrations in 'online' mode (use async engine)."""
